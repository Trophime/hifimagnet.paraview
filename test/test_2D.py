...
from python_hifimagnetParaview.case2D.method2D import create_dicts_fromjson

cases = [
    (
        "./test/cases/cfpdes-thmagel-2d-static-linear/Tore/np_1/cfpdes.exports/Export.case",
        "./test/models/cfpdes_Tore_2d_static/Tore_elas_2d.json",
    )
]
...
def test_views(file, jsonfile):
    ...
    for field in [
        ...
        imageref = f"./test/Pictures/2D/{field}.png"
